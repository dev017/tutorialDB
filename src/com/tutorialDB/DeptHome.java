...
public class DeptHome {
	...
	public Dept merge(Dept detachedInstance) {
		...
		try {
			Dept result = (Dept) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Dept findById(java.lang.Integer id) {
		...
		try {
			Dept instance = (Dept) sessionFactory.getCurrentSession().get(
					"com.tutorialDB.Dept", id);
			if (instance == null) {
	...
	public List<Dept> findByExample(Dept instance) {
		...
		try {
			List<Dept> results = (List<Dept>) sessionFactory
					.getCurrentSession().createCriteria("com.tutorialDB.Dept")
